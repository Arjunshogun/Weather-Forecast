...
![AeroCast Weather Dashboard](https://images.unsplash.com/photo-1592210454359-9043f067919b?auto=format&fit=crop&w=1200&q=80)
...
- **Air Quality Index (AQI)**: US AQI calculation and micro-pollutant metrics ($PM_{2.5}$, $PM_{10}$, $NO_2$, $O_3$, $CO$, $SO_2$).
